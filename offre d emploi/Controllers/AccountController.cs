...
namespace WebApplication5.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [HttpPost]
        public ActionResult EditProfile(EditeProfileViewModel profile)
        {
            var UserID = User.Identity.GetUserId();
            var user = db.Users.Where(a => a.Id == UserID).SingleOrDefault();
            if (!UserManager.CheckPassword(user, profile.CurentPassword))
            {
                ViewBag.Message = "Mot de passe error";
            ...
            else
            {
                ...
                db.SaveChanges();
                ViewBag.message = "vous avez bien modifier votre information";
            }
            return View(profile);
        }
